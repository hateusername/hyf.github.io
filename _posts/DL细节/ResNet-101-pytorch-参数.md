![](https://upload-images.jianshu.io/upload_images/9165719-132b686a715104cf.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
)AvgPool2d(kernel_size=7, stride=1, padding=0)Linear(in_features=2048, out_features=1000, bias=True)
```
